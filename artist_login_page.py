...
sign_in_label = Label(sign_in_frame, text="TARP", font=("Helvetica", 30, "bold"), fg='white', bg='black')
ups_label = Label(sign_in_frame, text=ups, font=("Helvetica", 30), fg='gray', bg='black')
sign_in_label.grid(row=0, column=0, columnspan=2, padx=10, pady=5)
ups_label.grid(row=1, column=0, columnspan=2)
name_label = Label(sign_in_frame, text="username", font=("Helvetica", 20), fg='gray', bg='black')
name_label.grid(row=2, column=0)
name_entry = Entry(sign_in_frame, width=30, bg='white', fg='black')
name_entry.grid(row=2, column=1, padx=10, pady=10)
password_label = Label(sign_in_frame, text="Password", font=("Helvetica", 20), fg='gray', bg='black')
password_label.grid(row=3, column=0)
password_entry = Entry(sign_in_frame, width=30, bg='white', fg='black')
password_entry.grid(row=3, column=1, padx=10, pady=10)

#sign in button
sign_in_button = Button(sign_in_frame, text="Tarp In!", width=25, bg='gray', fg='black')
